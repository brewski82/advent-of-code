...
(defun union-boxes (map distance)
  "Union-Find style operation: merge two circuits/boxes together. Merge two
circuits when their junction boxes are connected. Map: fset map of point ->
circuit (set of points). Returns updated map where both points and their
circuits point to the merged set."
...
coordinates of the final two boxes."
  (bind (((:structure distance- point-a point-b) distance)
    ...
    (if (all-connected-p box-count map)
        ...
        map)))       ; Circuit contains all boxes
